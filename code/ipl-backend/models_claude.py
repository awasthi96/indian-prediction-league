...
class PredictedXFactor(Base):
    ...
    # Relationship
    prediction = relationship("PredictedXFactor", back_populates="x_factors")
...
3. Prediction → PredictedXFactors (One-to-Many)
   - One prediction can have MANY x-factors
   - Each x-factor belongs to ONE prediction

Visual Diagram:
   User (1) ----< Predictions (Many) >---- Match (1)
                        |
                        | (1)
                        |
                        v
                  PredictedXFactors (Many)
"""